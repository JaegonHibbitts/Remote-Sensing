...
fullDirectory = '/home/jhibbitt/Documents/Remote-Sensing/HW7/' + timestr + '.mp4'
# fullDirectory = os.path.abspath(timestr + '.mp4')
command = '/home/jhibbitt/Documents/Remote-Sensing/HW7/Dropbox-Uploader/dropbox_uploader.sh upload ' + fullDirectory + ' /ring_videos/'
os.system(command)
